...
public class Frames_Multiple {
	...
	public static void main(String[] args) {
		...
		System.out.println(driver.findElements(By.tagName("iframe")).size()); // Check no of frames present in the page
		
		driver.switchTo().frame(2); // frames with index
		driver.findElement(By.xpath("//*[@id=\"app\"]/div/main/section/div/div/div[1]/div/ul/li[2]/a")).click();
