...
public class base {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				"D:\\Selenium Training\\Selenium workspace\\E2EProject\\src\\main\\java\\resources\\data.properties");
	...
	public void getScreenshot(String result) throws IOException {
		...
		FileUtils.copyFile(src, new File("D:\\Selenium Training\\screenshot" + result + "screenshot.png"));
