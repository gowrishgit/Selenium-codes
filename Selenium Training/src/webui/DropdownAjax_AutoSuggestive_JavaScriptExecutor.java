...
public class DropdownAjax_AutoSuggestive_JavaScriptExecutor {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		int i = 0;
		while (!placename.equalsIgnoreCase("BANGALORE")) {
			i++;
			...
			if (i > 10) // this used when placename is not found and limit to check 10 times
			{
				break;
			}
		}
